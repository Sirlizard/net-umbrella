    ...
    return (
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button onClick={onBack} className="px-3 py-2 text-sm bg-gray-100 text-[#e8e6d8] rounded-lg hover:bg-gray-200 transition-colors duration-200">Back</button>
        </div>
        <div className="text-center py-16">
          <Users className="w-16 h-16 text-gray-300 mx-auto mb-4" />
          <p className="text-[#e8e6d8]">No friends added yet. Add some friends to see analytics!</p>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button onClick={onBack} className="px-3 py-2 text-sm bg-gray-100 text-[#e8e6d8] rounded-lg hover:bg-gray-200 transition-colors duration-200">Back to Dashboard</button>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-sm text-[#e8e6d8]">Total Messages</p>
                <p className="text-xl font-semibold text-[#ffacd6]">{analytics.totalMessages.toLocaleString()}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
            <div className="flex items-center space-x-3">
              <div className="bg-[#ffacd6]/20 p-2 rounded-lg">
                <TrendingUp className="w-5 h-5 text-[#ffacd6]" />
              </div>
              <div>
                <p className="text-sm text-[#e8e6d8]">Avg per Friend</p>
                <p className="text-xl font-semibold text-[#ffacd6]">{analytics.avgMessagesPerFriend}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-sm text-[#e8e6d8]">Most Active</p>
                <p className="text-sm font-semibold text-[#ffacd6] truncate">{analytics.mostActiveFriend.name}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-sm text-[#e8e6d8]">Reconnect With</p>
                <p className="text-sm font-semibold text-[#ffacd6] truncate">{analytics.reconnectFriend.name}</p>
                <p className="text-xs text-[#e8e6d8]">{analytics.reconnectDays} days ago</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 space-y-4 md:space-y-0">
          <div className="flex items-center space-x-4">
            <div>
              <label className="block text-sm text-[#e8e6d8] mb-1">Select Friend</label>
              <select
            ...
            <div>
              <label className="block text-sm text-[#e8e6d8] mb-1">Chart Type</label>
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs text-[#e8e6d8]">Sent ({selectedFriend?.messages_sent_count || 0})</span>
            </div>
            <div className="flex items-center space-x-2">
              <span className="inline-block w-4 h-1 bg-[#ffacd6] rounded" />
              <span className="text-xs text-[#e8e6d8]">Received ({selectedFriend?.messages_received_count || 0})</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-4 text-center">
          <p className="text-sm text-[#e8e6d8]">

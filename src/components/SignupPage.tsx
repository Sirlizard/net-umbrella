...
export const SignupPage: React.FC<SignupPageProps> = ({ onSwitchToLogin }) => {
  ...
  <div className="bg-white rounded-xl shadow-lg p-8 border border-pink/20">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-red mb-2">
              Create Account
            </h1>
            <p className="text-blue">
              Join your connections network
            </p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-red mb-2">
                Email Address
              </label>
              <input
                id="email"
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-medium text-red mb-2">
                Password
              </label>
              <input
                id="password"
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-red mb-2">
                Confirm Password
              </label>
              <input
                id="confirmPassword"

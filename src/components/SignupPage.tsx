      ...
      <div className="min-h-screen bg-[#e8e6d8] flex items-center justify-center px-4">
        <div className="max-w-md w-full">
          <div className="bg-white rounded-xl shadow-lg p-8 border border-[#ffacd6]/20 text-center">
            ...
            <p className="text-[#624a4a] mb-6">
              We've sent you a confirmation link. Please check your email and click the link to verify your account.
            </p>
            <button
              onClick={onSwitchToLogin}
              className="bg-[#28428c] text-white py-3 px-6 rounded-lg hover:bg-[#1e3366] transition-colors duration-200 font-medium"
            >
              Back to Sign In
            </button>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 border border-[#ffacd6]/20">
          <div className="text-center mb-8">
            ...
            <p className="text-[#624a4a]">
              Create your account and start building amazing friendships
            </p>
          </div>

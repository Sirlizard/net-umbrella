    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
      ...
      {recommended && (
        <div className="mb-6 border border-gray-100 rounded-lg p-4 bg-[#e8e6d8]">
          ...
          <div className="mt-3">
            <label className="block text-xs text-[#e8e6d8] mb-1">Suggested message</label>
            <div className="p-3 bg-white border border-gray-200 rounded-lg text-sm text-[#e8e6d8]">
              {suggestionText}
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div className="md:col-span-2 flex items-end justify-end space-x-4">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xs text-[#e8e6d8]">Sent</span>
          </div>
          <div className="flex items-center space-x-2">
            <span className="inline-block w-4 h-1 bg-[#ffacd6] rounded" />
            <span className="text-xs text-[#e8e6d8]">Received</span>
          </div>
        </div>
      </div>
